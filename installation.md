...
[here]({{ site.baseurl }}{% link _collection/config-properties.md %}).
...
installer. You can find information about such configuration [here]({{ site.baseurl }}{% link _collection/config-properties.md %}).
