...
1. Go to the [download area](/download) and download `OpenWebStart_windows-x64_0_1_x-alpha.zip`.
1. Run the installer.
...
Example: `C:\Program Files\OpenWebStart\javaws -nosecurity -Xnofork -jnlp myApp.jnlp -console`
